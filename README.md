...
24/7 deep multi-model bug-hunting automation for **OBI Group Holding SE & Co. KGaA** (Oliver Maicher bug-bounty hub).

Scope: All company-owned infrastructure, retail systems, e-commerce platforms, mobile applications, APIs, supply chain systems, customer accounts, and domains operated by OBI Group and its subsidiaries
...
> is never accepted. Active testing is gated behind the in-scope hosts in `inventory/obi.md` and
...
Program description: German multinational DIY and home improvement retail group operating stores and digital platforms across Europe
